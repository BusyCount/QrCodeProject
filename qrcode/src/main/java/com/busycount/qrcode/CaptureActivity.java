...
import com.busycount.qrcode.camera.CameraManager;
import com.busycount.qrcode.decoding.CaptureActivityHandler;
import com.busycount.qrcode.decoding.DecodeImage;
import com.busycount.qrcode.decoding.InactivityTimer;
import com.busycount.qrcode.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements Callback, View.OnClickListener {
    ...
    public static final int REQUEST_CODE_QR = 0x3700;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ImageUtils.TAKE_PHOTO_FROM_ALBUM) {
